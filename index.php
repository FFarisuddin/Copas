...
<div style="max-width:100%;max-height:100%" align="center" display:table>
    <div>
        <form action="index.php" method="post" enctype="multipart/form-data">
            <input style="max-width:500px;max-height:30px" type="file" name="photo" accept=".jpeg,.jpg,.png" required="" />
            <input style="max-width:100px;max-height:30px" type="submit" name="submit" value="MAGIC" />
        </form> 
